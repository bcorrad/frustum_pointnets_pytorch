...
class FrustumPointNetLoss(nn.Module):
    ...
    def forward(self, logits, mask_label, \
        ...
        '''
        # print("Device of ", heading_class_label, " is ", heading_class_label.device)
        ...
        hcls_onehot = torch.eye(NUM_HEADING_BIN).cuda()[heading_class_label.long()] # 32,12
        ...
        scls_onehot = torch.eye(NUM_SIZE_CLUSTER).cuda()[size_class_label.long()]  # 32,8
